...
def validate_input(user_input):
    try:
        landmark_ids = [
            int(id.strip()) for id in user_input.split(",") if id.strip().isdigit()
        ]
        ...
        print(
            f"Invalid input. Please enter numbers between 0 and {MAX_LANDMARKS}, comma-separated."
        )
        return None
        ...
        while True:
            ...
            try:
                ...
                if validated_ids is not None:
                    ...
                    print(
                        "To see new landmarks, type their IDs again (comma-separated) and press enter."
                    )
            except queue.Empty:
                pass
